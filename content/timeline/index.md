...
.days-stack{display:flex;flex-direction:column;gap:1.4rem;}
...
.d-meta{margin:0;font-size:.65rem;letter-spacing:.4px;opacity:.65;}
.tz-line{margin:1.4rem 0 0;font-size:.68rem;letter-spacing:.45px;opacity:.70;padding:.35rem .75rem .35rem 0;border-left:4px solid var(--hb-active,#e1306c);background:none!important;border-radius:0;}
body.dark .tz-line{opacity:.75;background:none!important;}
